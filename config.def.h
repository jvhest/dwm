...
static const char *fonts[]          = { "monospace:size=10", "JetBrainsMono Nerd Font:size=9" };
static const char dmenufont[]       = "monospace:size=9";	/* JetBrainsMono Nerd Font:size=9"; */
...
/* commands */
static const char *dmenucmd[] = { "dmenu_run", "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_gray1, "-sf", col_gray4, NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,              XK_Up,     spawn,          {.v = volmaxcmd } },
	{ MODKEY|ShiftMask,             XK_Down,   spawn,          {.v = volmutecmd } },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
